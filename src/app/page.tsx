          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg transition-transform hover:scale-105">
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold text-center mb-4">Simulador Educacional</h3>
                <p className="text-gray-600 mb-6">
                  Desvende os mistérios da renda fixa e CDI, com juros compostos e inflação na prática.
                </p>
            ...
            <div className="bg-white rounded-lg shadow-lg transition-transform hover:scale-105">
              <div className="p-6">
                <div className="text-center mb-4">
                  <PiggyBank className="h-12 w-12 mx-auto text-blue-600" />
                </div>
                <h3 className="text-xl font-semibold text-center mb-4">PGBL vs CDB</h3>
                <p className="text-gray-600 mb-6">
                  Compare PGBL e CDB e encontre o investimento perfeito para você, sem complicações.
                </p>
                <div className="text-center">
                  <Link
            ...
            <div className="bg-white rounded-lg shadow-lg transition-transform hover:scale-105">
              <div className="p-6">
                <div className="text-center mb-4">
                  <Banknote className="h-12 w-12 mx-auto text-blue-600" />
                </div>
                <h3 className="text-xl font-semibold text-center mb-4">Simulador de Investimentos</h3>
                <p className="text-gray-600 mb-6">
                  Veja seu patrimônio crescer com aportes e juros. Planejar nunca foi tão fácil e estimulante.
                </p>
                <div className="text-center">
                  <Link
